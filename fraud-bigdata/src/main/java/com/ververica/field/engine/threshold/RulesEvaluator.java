package com.ververica.field.engine.threshold;
...
import com.ververica.field.sinks.CurrentRulesSink;
import com.ververica.field.sinks.LatencySink;
import com.ververica.field.sources.RulesSource;
import com.ververica.field.sources.TransactionsSource;
...
public class RulesEvaluator {
    ...
    public void runDynamicThreshold() throws Exception {
        ...
        SingleOutputStreamOperator<Alert> alerts = transactions
                ...
                .keyBy(
                        Keyed::getKey, // 按键分组
                        TypeInformation.of(String.class) // 显式指定键类型
                )
                .connect(rulesStream)
