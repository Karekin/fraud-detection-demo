...
@Component
public class RulesStreamBootstrapper implements ApplicationRunner {

    private RuleRepository ruleRepository;
    private FlinkRulesService flinkRulesService;

    @Autowired
    public RulesStreamBootstrapper(RuleRepository userRepository, FlinkRulesService flinkRulesService) {
